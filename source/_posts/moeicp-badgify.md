...
你也想让你的萌备用上漂亮的**徽章**吗![My own MoeICP badge](https://images.oxue.de/file/moeicp/20252235.svg)
...
- 如果想要使用**带图标的**，下载[此文件](https://images.oxue.de/file/moeicp/20252235.svg)并依照[方法二](#方法二使用矢量图)自行替换
  {% note info %}
  图标来自[萌备](https://icp.gov.moe/images/gov.svg)
  {% endnote %}
...
- 如果需要让访客点击徽章就跳转到你的萌备详情页，需要用到`<a>`标签：
  ...
  />
  <img
    src="https://images.oxue.de/file/moeicp/20252235.svg"
  />
  </a>
  ```
