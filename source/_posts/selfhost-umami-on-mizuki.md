...
因[此次提交](https://github.com/matsuzaka-yuki/Mizuki/commit/1dcaa613759be51778c6b9e16896ea13d4b48b44)后，Mizuki 的 Umami 实现方式已变，此文章仅适用**Mizuki ≤ 8.2**<br>
...
- 选`Body`页，**Content Type** 选`application/json`，**Raw Request Body** 填
  ...
  ```
- 点蓝色按钮`Send`，稍等片刻，下方就会出现`token`![e.g.](https://images.oxue.de/file/p/3/SamI0fVW.webp)
